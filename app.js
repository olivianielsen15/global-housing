...
const layerConfig = {
    ...
    mortgagePenetrationPerCapita: {
        title: 'Mortgage Penetration per Capita',
        description: 'Outstanding residential mortgage debt per capita (USD). Measures depth of housing finance systems and mortgage market maturity. Higher values (green) = mature mortgage markets enabling homeownership. Lower values (red) = limited formal finance, cash-dominated markets. Based on IMF Global Debt Database, World Bank Financial Development Indicators, BIS Residential Property Database (2024).',
        detailedDefinition: 'This metric measures the total outstanding residential mortgage debt divided by population, revealing housing finance system depth and accessibility. High values ($40,000-60,000+) indicate mature Anglo-Nordic mortgage markets: Denmark $56,800 (world leader with 120% mortgage debt/GDP), Switzerland $60,200 (highest per capita), Norway $52,300, Netherlands $51,200, Australia $48,500, New Zealand $44,600. These countries have deep financial systems, widespread homeownership through leverage, and sophisticated mortgage products (fixed/variable rates, long terms). Medium-high ($20,000-40,000): Developed markets like USA $35,200, Canada $38,400, UK $33,800, Singapore $35,600, France $24,300, showing established mortgage cultures with most households accessing housing finance. Medium ($10,000-20,000): Maturing markets like Germany $19,800 (rental culture limits), Japan $18,500 (aging deleveraging), South Korea $21,800 (jeonse + mortgages), Spain $17,600 (post-2008 deleveraging), Poland $6,800. Low ($1,000-10,000): Emerging mortgage markets like Chile $7,200 (Latin America leader), China $6,800 (rapid 2000s-2020s growth), Malaysia $4,200, South Africa $3,200, showing developing but limited finance access. Very Low (<$1,000): Cash-dominated markets with minimal formal housing finance - India $420, Indonesia $680, Philippines $520, Pakistan $180, Bangladesh $95, Nigeria $95, Ethiopia $65. These countries have underdeveloped financial systems, limited banking access, informal/family financing dominates. The divide is stark: Nordic/Anglo countries have 100-600x more mortgage debt per capita than African/South Asian nations, reflecting fundamental differences in financial inclusion, property rights, credit systems, and homeownership pathways. Data sources: IMF Global Debt Database (most comprehensive, 190+ countries), World Bank Global Financial Development Database, BIS Residential Property Price Statistics, OECD National Accounts, central bank financial stability reports. Mortgage debt includes residential mortgages only, excludes commercial real estate. Policy implications: Low-penetration countries need financial sector development (credit bureaus, collateral registries, foreclosure laws), affordable housing finance institutions (like India\'s NHB, Mexico\'s Infonavit), and macroprudential regulation to avoid overleveraging. High-penetration countries face household debt sustainability risks, as seen in 2008 financial crisis. Optimal penetration balances homeownership access with financial stability. Mortgage finance is critical for affordable housing - without it, only wealthy can afford homeownership, perpetuating inequality.',
        dataKey: 'mortgagePenetrationPerCapita',
        scale: [0, 25000],
        unit: ' USD/capita',
        reversed: true  // Higher is better - better access to housing finance
    },
    homeInsurancePenetration: {
        title: 'Home Insurance Penetration',
        description: 'Annual home insurance premiums per capita (USD). Measures insurance market sophistication and risk protection culture. Higher values (green) = strong insurance markets protecting housing assets. Lower values (red) = minimal insurance, vulnerable to disasters. Based on Swiss Re Sigma World Insurance Reports, national insurance regulators (2024).',
        detailedDefinition: 'This metric measures annual residential property insurance premiums divided by population, revealing insurance market depth and risk management culture. Very High ($400-800): Anglo-American markets with mandatory/widespread coverage - USA $720 (lender requirement for mortgages, hurricane/flood/fire risks), Switzerland $680 (highest per capita globally), Australia $640 (cyclone/bushfire risks drive coverage), Netherlands $580 (flood risk awareness). These countries have mature insurance industries, high homeownership, strong risk culture, and often mandatory requirements. High ($300-500): Nordic/Western Europe with comprehensive coverage - Norway $520, Denmark $510, Sweden $490, Finland $440, Luxembourg $450, showing welfare states + insurance tradition. Insurance integrated into housing finance. Medium ($150-300): Moderate insurance markets - UK $420, Japan $420 (earthquake/typhoon), New Zealand $580 (earthquake insurance fund), France $350 (mandatory for renters), Canada $380, Germany $280. Growing awareness but not universal coverage. Low ($50-150): Emerging insurance markets - South Africa $95, Czech Republic $120, Poland $85, Chile $120, Morocco $32, Turkey $48. Small middle-class with insurance, but majority uninsured. Very Low (<$50): Minimal insurance penetration - Brazil $28, Mexico $35, China $45, Indonesia $12, Philippines $8 (despite typhoon risk), India $4, Pakistan $2, Bangladesh $1, Nigeria $4, Ethiopia $1. Despite facing major disaster risks (earthquakes, floods, cyclones), populations are uninsured and vulnerable. The insurance gap is massive: USA residents pay 720x more home insurance per capita than Bangladeshis, despite Bangladesh facing severe cyclone/flood risks. This reflects income differences, insurance industry development, regulatory frameworks, and risk culture. Uninsured populations face catastrophic losses from disasters, perpetuating poverty cycles. Data sources: Swiss Re Sigma World Insurance Reports (authoritative global data), national insurance regulators (US NAIC, UK FCA, etc.), OECD Insurance Statistics, World Bank Financial Sector data. Includes property/homeowners insurance only, excludes life/health/auto. Policy implications: Low-penetration countries need insurance sector development, microinsurance products for low-income households, parametric disaster insurance, and building code enforcement (reduces premiums). Insurance is critical for housing resilience - without it, disasters destroy housing wealth permanently. Countries with high disaster risk but low insurance (Philippines, Bangladesh, Nepal) face perpetual reconstruction cycles. Governments should mandate/incentivize insurance (like France) or create public catastrophic funds (like New Zealand Earthquake Commission).',
        dataKey: 'homeInsurancePenetration',
        scale: [0, 300],
        unit: ' USD/capita/year',
        reversed: true  // Higher is better - better risk protection
    }
};
...
function updateStatsPanel(countryData) {
    ...
    statsPanel.innerHTML = `
        ...
        <div class="country-stats">
            ...
            <p><strong>Mortgage Penetration:</strong> $${countryData.mortgagePenetrationPerCapita.toLocaleString()}/capita (outstanding debt)</p>
            <p><strong>Home Insurance:</strong> $${countryData.homeInsurancePenetration.toLocaleString()}/capita/year (premiums)</p>
