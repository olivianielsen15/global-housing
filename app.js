...
const layerConfig = {
    ...
    urbanizationRate: {
        ...
        description: 'Percentage of total population living in urban areas. Data from UN World Urbanization Prospects (2024). Higher values (green) = more urbanized societies with greater housing density needs. Lower values (red) = rural-dominated populations with emerging urban housing demand as migration accelerates.',
        detailedDefinition: 'This metric measures the share of a country\'s population residing in urban areas as defined by national statistical offices and harmonized by the UN Population Division. Urbanization is the single most powerful driver of housing demand globally. As people move from rural to urban areas, they shift from self-built housing to formal housing markets, creating enormous demand for urban housing units, infrastructure, and services. Very High (85-100%): City-states and highly urbanized nations - Singapore 100%, Kuwait 100%, Belgium 98%, Qatar 96%, Japan 92%, Argentina 92%, Australia 87%, USA 83%. These countries face housing challenges centered on affordability, density, and renewal rather than absolute shortage. High (70-85%): Mature urbanized economies - UK 84%, Germany 78%, France 82%, Brazil 87%, Chile 88%, South Korea 82%, Canada 82%. Urban housing systems are established but face gentrification, suburban sprawl, and aging stock challenges. Medium (50-70%): Rapidly urbanizing nations at the tipping point - China 65%, Indonesia 58%, India 36% (but rising fast), Nigeria 54%, Egypt 43%, Morocco 65%. These countries face the most acute housing construction needs as millions migrate to cities annually. Low (25-50%): Predominantly rural with accelerating urbanization - Bangladesh 40%, Kenya 29%, Ethiopia 23%, Uganda 26%, Cambodia 25%, Nepal 22%. Rural-to-urban migration is creating massive informal settlement growth. Very Low (<25%): Highly rural societies - Malawi 18%, Rwanda 18%, Niger 17%, Burundi 14%. Urbanization is just beginning, offering opportunities to plan ahead but also risks of unplanned growth. Urbanization rate directly impacts: housing deficit severity (faster urbanization = larger gap between supply and demand), informal housing growth (when formal markets can\'t keep pace), infrastructure needs (water, sanitation, transport), land prices (urban land scarcity drives costs), and housing policy priorities (urban vs rural investment). The world crossed 50% urban in 2007 and is projected to reach 68% by 2050, with virtually all growth in Africa and Asia. Countries urbanizing at 1-2% annually need to build millions of housing units per decade just to keep pace. This metric contextualizes all other housing metrics - a country\'s urbanization level fundamentally shapes its housing challenges and policy needs.',
        dataKey: 'urbanizationRate',
        scale: [15, 100],
        unit: '%',
        reversed: true  // Higher is better - more developed urban systems
    },
